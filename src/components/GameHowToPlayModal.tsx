      ...
      <SheetContent side="right" className="max-w-md w-full bg-white">
        ...
        <div className="py-4 text-base space-y-4 text-black overflow-y-auto" style={{ maxHeight: "60vh" }}>
          <ol className="list-decimal list-inside space-y-2">
            ...
            <li>
              The game ends if a player reaches <span className="font-bold">20 points</span> or drops to <span className="font-bold">0 points</span>.
            </li>
          </ol>
          <div className="pt-4 text-center text-base font-semibold">
            <span
              className="block"
              style={{
        ...
        <div className="flex justify-end pt-2">
          <SheetClose asChild>
            <Button variant="secondary" className="text-black">Close</Button>
          </SheetClose>
        </div>
      </SheetContent>
    </Sheet>
